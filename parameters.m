...
% params.num_ant_x = 1;               % number of UPA antenna array on the x-axis
% params.num_ant_y = 8;               % number of UPA antenna array on the y-axis
% params.num_ant_z = 4;               % number of UPA antenna array on the z-axis

% params.num_ant_MS_x = 1;               % number of UPA antenna array on the x-axis
% params.num_ant_MS_y = 1;               % number of UPA antenna array on the y-axis
% params.num_ant_MS_z = 1;               % number of UPA antenna array on the z-axis


% Antenna spacing
% params.ant_spacing = .5;            % ration of wavelength for half wavelength enter .5
% params.ant_spacing_MS = .5;          % ration of wavelength for half wavelength enter .5
